      ...
      <div className="rd-body">
        ...
        <aside className="rd-sidebar">
          <ul className="rd-nav">
            ...
            <li className={activeTab === 'operation_theatre' ? 'active' : ''} onClick={() => setActiveTab('operation_theatre')}>
        ...
        <main className="rd-main">
          ...
          {activeTab === 'blood_bank' && (
            <div style={{ padding: '0 4px' }}>
              <BloodBankManagement role="receptionist" loggedInUser={loggedInStaff || { name: 'Receptionist Desk' }} />
            </div>
          )}
